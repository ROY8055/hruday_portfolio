          ...
          <div className="space-y-6">
            <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                websites. Recently graduated with a batchlor of degree in Artificial Intelligence and Machine Learning, I specialize in using 
            ...
            <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <h4 className="font-medium text-gray-900 dark:text-white">Artificial Intelligence and Machine Learning</h4>
